...
type V2 = (Float, Float)
type TestInfo = (String, String, String, [Obj], [Obj])
...
genTests (testName, subName, styName, initTruth, finalTruth) = 
        let nameInit = testName ++ ": init state" in
        let nameFinal = testName ++ ": final state" in
        let initState = unsafePerformIO $ mainRetInit subName styName in
...
venn_subset = ("venn diagram with subset relationships", 
              ...
              [C (Circ {xc = 100.0, yc = 100.0, r = 109.60964, selc = False, namec = "A", colorc = makeColor 0.8350866 0.11711092 0.37933916 0.5}),C (Circ {xc = 100.0, yc = 100.0, r = 67.93451, selc = False, namec = "B", colorc = makeColor 0.53591585 0.30000886 0.74808437 0.5}),C (Circ {xc = 100.0, yc = 100.0, r = 53.009216, selc = False, namec = "C", colorc = makeColor 0.39221647 0.35450098 0.32681206 0.5}),C (Circ {xc = 100.0, yc = 100.0, r = 33.96016, selc = False, namec = "D", colorc = makeColor 0.8609598 0.4674169 0.19085282 0.5}),C (Circ {xc = 100.0, yc = 100.0, r = 42.626465, selc = False, namec = "E", colorc = makeColor 0.46498597 0.48061144 0.34299543 0.5}),C (Circ {xc = 100.0, yc = 100.0, r = 27.86782, selc = False, namec = "F", colorc = makeColor 0.7034269 0.83372575 0.60223794 0.5}),C (Circ {xc = 100.0, yc = 100.0, r = 33.43241, selc = False, namec = "G", colorc = makeColor 0.10927472 0.6487766 0.57733524 0.5}),L (Label {xl = -215.91048, yl = -323.48157, wl = 0.0, hl = 0.0, textl = "A", sell = False, namel = "Label_A"}),L (Label {xl = -181.55002, yl = 266.21893, wl = 0.0, hl = 0.0, textl = "B", sell = False, namel = "Label_B"}),L (Label {xl = 73.725464, yl = 194.07147, wl = 0.0, hl = 0.0, textl = "C", sell = False, namel = "Label_C"}),L (Label {xl = -385.6619, yl = -142.9386, wl = 0.0, hl = 0.0, textl = "D", sell = False, namel = "Label_D"}),L (Label {xl = -208.02817, yl = -236.49031, wl = 0.0, hl = 0.0, textl = "E", sell = False, namel = "Label_E"}),L (Label {xl = -297.68423, yl = -252.173, wl = 0.0, hl = 0.0, textl = "F", sell = False, namel = "Label_F"}),L (Label {xl = 46.285065, yl = 337.4803, wl = 0.0, hl = 0.0, textl = "G", sell = False, namel = "Label_G"})],
            -- NOTE: this is the optimized version not from server, with 0 label size
            [C (Circ {xc = -14.655652, yc = 32.56527, r = 133.57823, selc = False, namec = "A", colorc = makeColor 0.8350866 0.11711092 0.37933916 0.5}),C (Circ {xc = -97.782814, yc = 21.536556, r = 49.7892, selc = False, namec = "B", colorc = makeColor 0.53591585 0.30000886 0.74808437 0.5}),C (Circ {xc = 29.272768, yc = 69.7233, r = 76.12503, selc = False, namec = "C", colorc = makeColor 0.39221647 0.35450098 0.32681206 0.5}),C (Circ {xc = -125.64388, yc = 18.908413, r = 21.852861, selc = False, namec = "D", colorc = makeColor 0.8609598 0.4674169 0.19085282 0.5}),C (Circ {xc = -77.57483, yc = -0.4377612, r = 19.968372, selc = False, namec = "E", colorc = makeColor 0.46498597 0.48061144 0.34299543 0.5}),C (Circ {xc = -1.1972563, yc = 22.523321, r = 19.973598, selc = False, namec = "F", colorc = makeColor 0.7034269 0.83372575 0.60223794 0.5}),C (Circ {xc = 54.085155, yc = 120.269295, r = 19.934216, selc = False, namec = "G", colorc = makeColor 0.10927472 0.6487766 0.57733524 0.5}),L (Label {xl = -35.514885, yl = -30.927202, wl = 0.0, hl = 0.0, textl = "A", sell = False, namel = "Label_A"}),L (Label {xl = -102.90838, yl = 45.922462, wl = 0.0, hl = 0.0, textl = "B", sell = False, namel = "Label_B"}),L (Label {xl = 58.462524, yl = 94.21728, wl = 0.0, hl = 0.0, textl = "C", sell = False, namel = "Label_C"}),L (Label {xl = -134.79979, yl = 12.899418, wl = 0.0, hl = 0.0, textl = "D", sell = False, namel = "Label_D"}),L (Label {xl = -71.55721, yl = -8.419043, wl = 0.0, hl = 0.0, textl = "E", sell = False, namel = "Label_E"}),L (Label {xl = -7.1897388, yl = 14.514438, wl = 0.0, hl = 0.0, textl = "F", sell = False, namel = "Label_F"}),L (Label {xl = 58.17983, yl = 129.39157, wl = 0.0, hl = 0.0, textl = "G", sell = False, namel = "Label_G"})])
            -- optimized version with label sizes--does not pass test
            -- [C (Circ {xc = -13.992373, yc = 33.430122, r = 133.43794, selc = False, namec = "A", colorc = makeColor 0.8350866 0.11711092 0.37933916 0.5}),C (Circ {xc = -97.970535, yc = 22.152693, r = 48.738552, selc = False, namec = "B", colorc = makeColor 0.53591585 0.30000886 0.74808437 0.5}),C (Circ {xc = 28.564419, yc = 70.800735, r = 76.83992, selc = False, namec = "C", colorc = makeColor 0.39221647 0.35450098 0.32681206 0.5}),C (Circ {xc = -126.2194, yc = 16.593975, r = 19.974989, selc = False, namec = "D", colorc = makeColor 0.8609598 0.4674169 0.19085282 0.5}),C (Circ {xc = -78.88705, yc = 0.63276935, r = 19.984423, selc = False, namec = "E", colorc = makeColor 0.46498597 0.48061144 0.34299543 0.5}),C (Circ {xc = -1.0821499, yc = 22.284103, r = 19.989868, selc = False, namec = "F", colorc = makeColor 0.7034269 0.83372575 0.60223794 0.5}),C (Circ {xc = 51.727608, yc = 122.82218, r = 19.948395, selc = False, namec = "G", colorc = makeColor 0.10927472 0.6487766 0.57733524 0.5}),L (Label {xl = -34.96278, yl = -29.925476, wl = 10.828125, hl = 16.359375, textl = "A", sell = False, namel = "Label_A"}),L (Label {xl = -101.79613, yl = 46.227833, wl = 9.15625, hl = 16.359375, textl = "B", sell = False, namel = "Label_B"}),L (Label {xl = 62.8032, yl = 88.26185, wl = 10.0, hl = 16.359375, textl = "C", sell = False, namel = "Label_C"}),L (Label {xl = -134.84679, yl = 11.543173, wl = 11.65625, hl = 16.359375, textl = "D", sell = False, namel = "Label_D"}),L (Label {xl = -72.756294, yl = -7.261844, wl = 9.15625, hl = 16.359375, textl = "E", sell = False, namel = "Label_E"}),L (Label {xl = -7.043495, yl = 14.253483, wl = 8.328125, hl = 16.359375, textl = "F", sell = False, namel = "Label_F"}),L (Label {xl = 57.63731, yl = 130.87152, wl = 10.828125, hl = 16.359375, textl = "G", sell = False, namel = "Label_G"})])

tree_subset = ("tree diagram with subset relationships", "src/sub/tree.sub", "src/sty/tree.sty",
